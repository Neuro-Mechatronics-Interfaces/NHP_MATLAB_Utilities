...
if (numel(varargin)==1) && isstruct(varargin{1})
    ...
    pars = struct;
    [pars.rootdir_raw, pars.rootdir_gen] = parameters('raw_data_folder', 'generated_data_folder');
...
f.Raw.Map = fullfile(f.Raw.Subj, sprintf("%s_%s_Muscle-Map.json", f.Tank, ARRAY));
...
f.Generated.Sync = fullfile(f.Generated.Block, sprintf("%s_sync.mat", block));
