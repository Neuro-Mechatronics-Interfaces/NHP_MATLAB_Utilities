...
opts.TMSi.Array.Stim_Blanking_Epoch = [-16 24];             % Samples to blank around stim onset and offset sample, respectively.
...
opts.TMSi.Bipolar.Stim_Blanking_Epoch = [-16 24];           % Samples to blank around stim onset and offset sample, respectively.
...
opts.TMSi.RMS.Stim_Blanking_Epoch = [-16 24];           % Samples to blank around stim onset and offset sample, respectively.
