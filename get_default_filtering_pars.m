...
opts.TMSi.Textiles.Apply_Stim_Blanking = true;                 % Apply stimulation artifact blanking to the data?
...
opts.TMSi.Textiles.Apply_Pre_Stimulus_Normalization = true;    % Normalize post-stimulus amplitudes by pre-stimulus mean and variance?
...
opts.TMSi.Textiles.Subgroups_CAR = {[1:32], [33:64]};          % Channel subgroups for CAR 
...
opts.TMSi.RMS.Subgroups_CAR = {1:64};                   % Channel subgroups for CAR
