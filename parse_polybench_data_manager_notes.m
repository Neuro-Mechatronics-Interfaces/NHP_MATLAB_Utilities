...
%
% Syntax:
%   [annotation, operator, recording] = parse_polybench_data_manager_notes(block_path);
%
% Example:
%   [Annotation, Operator, Recording] = parse_polybench_data_manager_notes('R:\NMLShare\raw_data\primate\Frank\Frank_2021_11_18');
